...
#' @description
#'
#' Essa função calcula o Giro do Ativo baseado em vetores relativos às
#' contas de ativo total e Receita líquida.
#'
#' @details
#' Apresenta como resultado uma lista com 4 itens:
#'
...
#'
#' 3.  **Índice** o Giro do Ativo dos períodos informados;
#'
#' 4.  **Análise Horizontal** Análise Horizontal das contas informadas no item 2.
#'
...
#'  atvTotal = c(300, 500),
#'  relatorio = TRUE,
#'  titulo = "Evolucao do Giro do Ativo",
#'  subtitulo = "",
#'  rodape = "",
#'  corFundo = "orange",
...
ind_giro <-
  ...
  ratio <-
    round(receitaLiquida / atvTotal, 4)
