...
#'
#' @description
#' Essa função calcula o saldo de tesouraria da empresa.
#'
#' @details
#' Trata-se da diferença entre ativo financeiro e passivo financeiro. Portanto, se
#' concentra nos ativos de curto prazo voltados à liquidez e exigibilidade onerosa.
#'
...
#'
#' 3.  **Índice** o Saldo de Tesouraria dos períodos informados;
#'
...
#' Ao acessar, fazer busca pelo nome da função `ind_saldoTesouraria`
#'
...
#' atvTotal = c(900, 800),
#' relatorio = TRUE,
#' titulo = "Evolucao do Saldo de Tesouraria",
#' subtitulo = "",
#' rodape = "",
#' corFundo = "orange",
