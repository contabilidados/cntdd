...
#'
#' @description
#' Essa função calcula o Ativo Financeiro da empresa, componente da análise dinâmica
#' de capital de giro.
#'
#' @details
#' Representa os valores de ativo circulante relacionados diretamente com ativos
#' circulantes cujos valores possuem liquidez imediata. Seus itens mais comuns são
...
#'
#' 3.  **Índice** o ativo financeiro dos períodos informados;
#'
...
#' Ao acessar, fazer busca pelo nome da função `ind_ativoFinanceiro`
#'
...
#'  atvTotal = c(900,800),
#'  relatorio = TRUE,
#'  titulo = "Evolucao do Ativo Financeiro",
#'  subtitulo = "",
#'  rodape = "",
#'  corFundo = "orange",
...
ind_ativoFinanceiro <-
  ...
  ratio <-
    cxEquiv + aplicFinanc + outAtvCircLiqImed
