...
#'
#' @description
#' Essa função calcula o Passivo Financeiro da empresa, componente da análise dinâmica
#' de capital de giro.
#'
#' @details
#' Representa os valores de passivo circulante relacionados diretamente com as
#' dívidas onerosas. Seus itens mais comuns são empréstimos e financiamentos de
#' curto prazo.
#'
...
#'
#' 3.  **Índice** o passivo financeiro dos períodos informados;
#'
...
#' Ao acessar, fazer busca pelo nome da função `ind_passivoFinanceiro`
#'
...
#'  indicador = "Passivo Financeiro",
#'  periodo = 2021:2022,
#'  empFinCP = c(120, 210),
#'  outPasCircOneroso = c(2, 10),
#'  atvTotal = c(900,800),
#'  relatorio = TRUE,
#'  titulo = "Evolucao do Passivo Financeiro",
#'  subtitulo = "",
#'  rodape = "",
#'  corFundo = "orange",
