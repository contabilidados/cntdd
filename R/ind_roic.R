...
#'
#' @description
#' Essa função calcula o Retorno sobre Capital Investido (ROIC).
#'
#' @details
...
#'
#' 3.  **Índice** o ROIC dos períodos informados;
#'
...
#' @param capitalOperLiquido Vetor com o capital operacional líquido da empresa
#' @param receitaLiquida Vetor com os valores da receita liquida da empresa
#' @param atvTotal Vetor com os valores do ativo total da empresa
...
#'
#' @seealso [ind_nopat()], [ind_capitalOperLiquido()]
#'
#' @examples
#' library(cntdd)
#'
...
#'  periodo = 2021:2022,
#'  nopat = c(150, 200),
#'  capitalOperLiquido = c(500, 460),
#'  receitaLiquida = c(300, 360),
#'  atvTotal = c(800, 930),
#'  relatorio = TRUE,
#'  titulo = "Evolucao do ROIC",
#'  subtitulo = "",
#'  rodape = "",
#'  corFundo = "orange",
...
ind_roic <-
  ...
  ratio <-
    round(nopat / capitalOperLiquido, 4)
  ...
  dtGeral <-
    data.frame(
      periodo            = periodo,
      nopat              = nopat,
      capitalOperLiquido = capitalOperLiquido,
      atvTotal           = atvTotal,
    ...
    mutate(
      ...
      AH.capitalOperLiquido = round(capitalOperLiquido / lag(capitalOperLiquido) - 1, 4),
      ...
      AV.capitalOperLiquido = capitalOperLiquido / atvTotal
    ) %>%
