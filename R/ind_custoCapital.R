...
#'
#' @description
#' Essa função calcula o Custo de Capital da Empresa pela multiplicação entre
#' o Capital Operacional Líquido e o WACC.
#'
#' @details
#' Valor em moeda que representa o quanto os sócios (capital próprio) e bancos
#' (capital de terceiros) esperam de retorno financeiro no período.
#'
...
#'
#' 3.  **Índice** o Custo de Capital da empresa dos períodos informados;
#'
...
#' Ao acessar, fazer busca pelo nome da função `ind_custoCapital`
#'
...
#' @param COL Vetor com os valores do capital operacional líquido da empresa
#' @param wacc Vetor com os valores do WACC (ou CMPC)
#' @param atvTotal Vetor com o ativo total da empresa
...
#'
#' @seealso [ind_capitalOperLiquido()], [ind_wacc()]
#'
#' @examples
#' library(cntdd)
#'
#' ind_custoCapital(
#'  indicador = "Custo de Capital",
#'  periodo = 2021:2022,
#'  COL = c(150,120),
#'  wacc = c(0.07, 0.06),
#'  atvTotal = c(303, 230),
#'  relatorio = TRUE,
#'  titulo = "Evolucao do Custo de Capital",
#'  subtitulo = "",
#'  rodape = "",
#'  corFundo = "orange",
