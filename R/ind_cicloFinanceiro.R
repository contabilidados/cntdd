...
#'
#' @description
#' Essa função calcula o Ciclo Financeiro da empresa
#'
#' @details
#' Representa a quantidade média de dias que a empresa financia (ciclo positivo)
#' suas atividades ou é financiada (ciclo negativo).
#'
...
#'
#' 3.  **Índice** o Ciclo Financeiro dos períodos informados;
#'
...
#' Ao acessar, fazer busca pelo nome da função `ind_cicloFinanceiro`
#'
...
#'  qdeDiasAno = 365,
#'  relatorio = TRUE,
#'  titulo = "Evolucao do Ciclo Financeiro",
#'  subtitulo = "",
#'  rodape = "",
#'  corFundo = "orange",
