...
#' Ao acessar, fazer busca pelo nome da função `ind_liqCorrente`
#'
...
#'  atvTotal = c(900,800),
#'  relatorio = TRUE,
#'  titulo = "Evolucao da Liquidez Corrente",
#'  subtitulo = "",
#'  rodape = "",
#'  corFundo = "orange",
...
ind_liqCorrente <-
  ...
  ratio <-
    round((cxEquiv + estoque + ctaRecCP + outAtvCirc)  /
    (fornec + dividasCP + outPasCirc), 4)
