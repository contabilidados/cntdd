#' Endividamento Financeiro sobre o Ativo Total (EFAT)
#'
#' @description
#' Essa função calcula o Endividamento Financeiro sobre o Ativo Total baseado em vetores
#' relativos as contas de passivo oneroso e ativo total.
#'
#' @details
...
#'
#' 3.  **Índice** o EFAT dos períodos informados;
#'
...
#' Ao acessar, fazer busca pelo nome da função `ind_endividamentoFinanceiro`
#'
...
#' @param empFinLP Vetor com os valores de empréstimos e financiamentos de curto prazo da empresa
#' @param empFinCP Vetor com os valores de empréstimos e financiamentos de longo prazo da empresa
...
#' library(cntdd)
#'
#' ind_endividamentoFinanceiro(
#' indicador = "Endividamento Financeiro",
#' periodo = 2021:2022,
#' empFinCP = c(8,10),
#' empFinLP = c(150,200),
#' atvTotal = c(558,510),
#' relatorio = TRUE,
#' titulo = "Evolucao do Endividamento Financeiro sobre o Ativo Total",
#' subtitulo = "",
#' rodape = "",
#' corFundo = "orange",
...
ind_endividamentoFinanceiro <-
  ...
  ratio <-
    round((empFinCP + empFinLP) / atvTotal, 4)
