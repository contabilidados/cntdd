...
#'
#' @description
#' Essa função calcula, de forma objetiva, o capital investido. Corresponde ao
#' investimento realizado por acionistas (sócios) e credores (bancos).
#'
#' @details
...
#'
#' 3.  **Índice** o capital investido dos períodos informados;
#'
...
#' Ao acessar, fazer busca pelo nome da funcao `ind_capitalInvestido`.
#'
...
#' @param empFinLP Vetor com os valores de empréstimos e financiamentos de
