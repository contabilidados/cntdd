...
#'
#' @description
#' Essa função calcula a Composição do Endividamento baseado em vetores
#' relativos as contas de passivo circulante e passivo não circulante.
#'
#' @details
...
#'
#' 3.  **Índice** a CE dos períodos informados;
#'
...
#' Ao acessar, fazer busca pelo nome da função `ind_composicaoEndividamento`
#'
...
#' library(cntdd)
#'
#' ind_composicaoEndividamento(
#'     indicador = "Composicao do Endividamento",
#'     periodo = 2021:2022,
#'     passivoCirculante = c(8,10),
#'     passivoNaoCirculante = c(150,200),
#'     atvTotal = c(558,510),
#'  relatorio = TRUE,
#'  titulo = "Evolucao da Composicao do Endividamento",
#'  subtitulo = "",
#'  rodape = "",
#'  corFundo = "orange",
...
ind_composicaoEndividamento <-
  ...
  ratio <-
    round(
      passivoCirculante / (passivoCirculante + passivoNaoCirculante), 4
    )
