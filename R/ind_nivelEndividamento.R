#' Nível de Endividamento do Ativo Total
#'
#' @description
#'
#' Essa função calcula o Nível de Endividamento da empresa baseado em vetores relativos às
#' contas de ativo total e patrimônio líquido.
#'
#' @details
...
#'
#' 3.  **Índice** o Nível de Endividamento dos períodos informados;
#'
...
#'  indicador = "Nivel de Endividamento",
#'  periodo = 2021:2022,
#'  patLiq = c(200, 150),
#'  atvTotal = c(300, 500),
#'  relatorio = TRUE,
#'  titulo = "Evolucao do Nivel de Endividamento",
#'  subtitulo = "",
#'  rodape = "",
#'  corFundo = "orange",
